...
# note that this code is basically the same as in twostagemodelup_bam.R for PLS biomass fitting, but with preprocessing to prepare inputs to bam() different
    ...
    write.csv(data[, c('PalEON','cell','total','x', 'y', 'biomass_avg','count')], paste0("C:/Users/jmurray7/Desktop/PalEON-FIA/stats/output/",taxon, ".observations.csv"))
    grid <- grid / 8000
  ...
  #####################
    ...
    write.csv(preds2[, c('x', 'y', 'cell','mean')], paste0("C:/Users/jmurray7/Desktop/PalEON-FIA/stats/output/",taxon, ".prediction.csv"))
    write.csv(preds2[, c('x', 'y', 'cell', 'sd')], paste0("C:/Users/jmurray7/Desktop/PalEON-FIA/stats/output/",taxon, ".uncertainty.csv"))
